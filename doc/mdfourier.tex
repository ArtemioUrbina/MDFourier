...
\begin{itemize}
	...
	\item Evaluate equipment, such as \textit{switchers} and \textit{upscalers} with audio \textit{passthrough}. It can help figure what effect they may have, signal by recoding with and without them connected in the \textit{Audio/Video} chain.
